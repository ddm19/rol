...
const CardsGrid: React.FC<Props> = ({ cards, onSelect, onAddToCart, isExpansionBlocked }) => {
    return (
                    ...
                    <div key={c.id_archivo} className="cardsGrid__card" onClick={() => c.imagen_url && onSelect?.(c)}>
                        ...
                        <div className="cardsGrid__meta">
                            ...
                            {onAddToCart && (
                                <button
                                    type="button"
                                    className={`cardsGrid__addButton${blocked ? ' cardsGrid__addButton--blocked' : ''}`}
                                    disabled={blocked}
                                    onClick={(event) => {
                                ...
                                >
                                    ...
                                    <span>{blocked ? 'Solo en Sobres' : 'Añadir'}</span>
                                </button>
                            )}
                        </div>
                    </div>
